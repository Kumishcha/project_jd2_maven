...
public class IncreaseQuantityInStockCommand implements Command {

	private static final ProductService productService = ServiceProvider.getInstance().getProductService();
	private static final Logger log = Logger.getLogger(IncreaseQuantityInStockCommand.class);
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		productCount = request.getParameter(RequestParameterName.REQ_PARAM_PRODUCT_COUNT);
		...
		try {
			...
			if (null == user) {
				...
				productService.increaseQuantityInStock(productName, productCount);
