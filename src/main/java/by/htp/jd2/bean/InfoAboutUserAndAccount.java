...
public class InfoAboutUserAndAccount {
	...
	public String toString() {
		return this.getClass().getSimpleName() + " [userId=" + userId + ", name=" + name + ", surname=" + surname + ", email="
				+ email + ", role=" + role + ", accountId=" + accountId + ", balance=" + balance + ", blocked="
				+ blocked + "]";
	}
}
